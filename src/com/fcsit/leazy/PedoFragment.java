...
//		mDesiredPaceView = (TextView) v.findViewById(R.id.desired_pace_value);
//
//		mIsMetric = mPedometerSettings.isMetric();
//		((TextView) v.findViewById(R.id.distance_units))
//				.setText(getString(mIsMetric ? R.string.kilometers
//						: R.string.miles));
//		((TextView) v.findViewById(R.id.speed_units))
//				.setText(getString(mIsMetric ? R.string.kilometers_per_hour
//						: R.string.miles_per_hour));
//
//		mMaintain = mPedometerSettings.getMaintainOption();
//		((LinearLayout) v.findViewById(R.id.desired_pace_control))
...
//			((TextView) v.findViewById(R.id.desired_pace_label))
